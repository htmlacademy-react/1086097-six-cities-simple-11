...
export default function CommentForm({hotelId}:CommentFormProps): JSX.Element {
  ...
  return (
    <form onSubmit={handleSubmitForm} className="reviews__form form" action="#" method="post">
      ...
      <textarea ref={textRef} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" defaultValue={reviewText} onChange={handleTextareaChange}></textarea>
